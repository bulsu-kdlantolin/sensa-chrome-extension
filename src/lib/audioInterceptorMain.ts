/**
 * @file lib/audioInterceptorMain.ts
 ...
 *    - By registering this script in `world: "MAIN"` via `chrome.scripting.registerContentScripts`, Chrome executes this script directly inside the host webpage's JavaScript world at `document_start`.
