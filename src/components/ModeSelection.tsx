...
export default function ModeSelection({ theme, onSelectMode }: ModeSelectionProps) {
  ...
  return (
    <div className={`w-[350px] h-[550px] px-6 py-8 flex flex-col items-center justify-center font-sans select-none overflow-hidden ${isDark ? 'bg-[#1C1C1E] text-gray-200' : 'bg-gray-50 text-black'}`}>
      ...
      <div className="flex flex-col items-center mb-8 transform-gpu">
        ...
        <p className={`text-[15px] font-medium mt-1 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
